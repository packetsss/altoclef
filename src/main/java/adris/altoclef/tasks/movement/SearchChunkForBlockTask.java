...
public class SearchChunkForBlockTask extends SearchChunksExploreTask {
    ...
    protected boolean isEqual(Task other) {
        if (other instanceof SearchChunkForBlockTask blockTask) {
            return Arrays.equals(blockTask.toSearchFor.toArray(Block[]::new), toSearchFor.toArray(Block[]::new));
        }
        return false;
    }
    ...
    protected String toDebugString() {
        return "Searching chunk for blocks " + ArrayUtils.toString(toSearchFor.toArray(Block[]::new));
    }
}
